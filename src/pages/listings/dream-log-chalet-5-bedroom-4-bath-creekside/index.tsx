          ...
          <div className="max-w-7xl mx-auto px-4 pt-8">
            <div className="flex justify-center mb-6">
              <div className="bg-black text-white rounded-full py-2 px-6 flex items-center space-x-4">
                ...
                <span>6-12 Month Minimum (booked 2025)</span>
              </div>
            </div>
            ...
            <div className="text-center mb-16">
              <p className="text-gray-700">90 Night Minimum</p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row mb-20">
              ...
              <div className="md:w-1/2 order-2 md:order-1">
                ...
                <p className="mb-4">
                  ...
                  the ground floor, this bedroom features a queen bed and has a
                  completely separate entrance to the home. It is perfect for
                  privacy for a family member wanting space from the main home,
                  and it has easy access through the front door to the main
                  house kitchen area.
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {photos.map((photo, index) => (
                  <div key={index} className="relative aspect-[4/3]">
                    <Image
                      src={photo}
                      alt={`Dream Log Chalet photo ${index + 1}`}
                      fill
                      className="object-cover"
                    />
                  </div>
