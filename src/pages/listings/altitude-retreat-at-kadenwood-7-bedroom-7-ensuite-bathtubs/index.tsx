...
const AltitudeRetreat = () => {
  ...
  // Property photos
  const photos = [
    "/photos/properties/Altitude-Retreat/altitude-retreat-1.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-2.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-3.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-4.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-5.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-6.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-7.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-8.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-9.jpg",
    "/photos/properties/Altitude-Retreat/altitude-retreat-10.jpg",
  ];
  ...
  return (
    <>
      <Head>
        <title>
          Altitude Retreat at Kadenwood | 7 Bedroom | 7 Ensuite Bathtubs -
          AceHost
        </title>
        <meta
          name="description"
          content="Experience Whistler luxury at its finest. This stunning 7-bedroom retreat in Kadenwood offers spacious accommodations for up to 14 guests, with ensuite bathrooms in every bedroom."
        />
      </Head>
        ...
        <main>
          ...
          <div className="max-w-7xl mx-auto px-4 pt-8">
            ...
            <div className="text-center mb-6 sm:mb-8">
              <p className="text-gray-700 text-sm sm:text-base">
                Long Term Monthly Rental Only | From $45,000/month
              </p>
            </div>
          </div>
          ...
          <div id="details" className="max-w-4xl mx-auto px-4 mb-10 sm:mb-16">
            ...
            <div className="prose prose-lg max-w-none">
              <p>
                The Altitude Retreat at Kadenwood is a stunning 7-bedroom luxury
                property located in Whistler&apos;s most prestigious
                neighborhood. This magnificent home offers unparalleled mountain
                views, privacy, and direct ski access.
              </p>
            </div>
          </div>
        </main>
