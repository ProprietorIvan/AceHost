  ...
  const allListings = [
    {
      ...
      image: "/photos/properties/Altitude Retreat/Altitude Retreat.jpg",
      guests: 14,
      bedrooms: 7,
      beds: 9,
      bathrooms: 7,
      priceRange: "$45,000-$55,000/month",
      winterPrice: "$55,000/month",
      holidayPrice: "$10,000/night",
      location: "whistler",
    ...
    },
    {
      ...
      beds: 10,
      bathrooms: 7,
      priceRange: "$5,800-$9,000+/night",
      winterPrice: "$9,000+/night",
      holidayPrice: "$9,000+/night",
      location: "whistler",
      link: "/listings/panoramic-estate-kadenwood",
    },
    {
      id: "slopeside-villa",
      name: "Slopeside Villa | Kadenwood",
      image: "/photos/properties/Slopeside Villa/Slopeside Villa.jpg",
      guests: 10,
      bedrooms: 5,
      beds: 7,
      bathrooms: 4,
      priceRange: "$15,000-$30,000/month",
      winterPrice: "$30,000/month",
      holidayPrice: "$6,000/night",
      location: "whistler",
    ...
    },
    {
      id: "stoneridge",
      name: "The Stoneridge",
      image: "/photos/properties/The Stoneridge/20221022 A7M3 02 A1_00285.jpg",
      guests: 8,
      bedrooms: 4,
      beds: 5,
      bathrooms: 3,
      priceRange: "$15,000-$25,000/month",
      winterPrice: "$25,000/month",
      holidayPrice: "$4,500/night",
      location: "whistler",
      link: "/listings/stoneridge",
    },
    {
      id: "two-cedars",
      name: "Two Cedars | Kadenwood",
      image: "/photos/properties/Two Cedars/Two-Cedars-Exterior.jpg",
      guests: 8,
      bedrooms: 4,
      beds: 6,
      bathrooms: 4.5,
      priceRange: "$15,000-$35,000/month",
      winterPrice: "$35,000/month",
      holidayPrice: "$6,000/night",
      location: "whistler",
    ...
    {
      id: "marquise-2-bed",
      name: "Marquise | 2 Bedroom | Ski in-Ski out",
      ...
      winterPrice: "$500/night | Winter",
      holidayPrice: "$300/night | Summer",
      location: "whistler",
      link: "/listings/marquise-2-bed-ski-in-ski-out",
    },
    {
      id: "whispering-pines",
      name: "Whispering Pines | Ski in-Ski out",
      ...
      winterPrice: "$550/night | Winter",
      holidayPrice: "$350/night | Summer",
      location: "whistler",
    ...
    },
    {
      ...
      beds: 8,
      bathrooms: 6.5,
      priceRange: "$45,000/month +",
      winterPrice: "$45,000/month | Winter",
    ...
    },
    {
      ...
      beds: 12,
      bathrooms: 7,
      priceRange: "$6,500-$9,500+/night",
      winterPrice: "$9,500+/night | Winter",
      holidayPrice: "$6,500/night | Summer",
      location: "whistler",
      link: "/listings/two-cedars-kadenwood",
    },
  ];
